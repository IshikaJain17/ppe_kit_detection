...
if __name__ == '__main__':
    ...
    prepare_and_send_email(sender='ishika2021csai121@abesit.edu.in',
                           recipient='ishika2021csai121@abesit.edu.in.com',
                           subject= 'People Count Exceeded', 
                           message_text= 'There are more than 4 persons are detected',
